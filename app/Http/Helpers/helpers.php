...
function getCustomers()
{
    ...
    CURLOPT_URL => 'https://softwaredevelopmentpro.myshopify.com/admin/api/2023-04/customers.json',
...
function getOrders()
{
    $curl = curl_init();   
    curl_setopt_array($curl, array(
    CURLOPT_URL => 'https://softwaredevelopmentpro.myshopify.com/admin/api/2023-04/orders.json',
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_ENCODING => '',
    CURLOPT_MAXREDIRS => 10,
    CURLOPT_TIMEOUT => 0,
