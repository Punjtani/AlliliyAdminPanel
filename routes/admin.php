...
Route::namespace('Admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::get('product/import/{id}/{slug}', 'ProductController@import')->name('products.import')->where('id', '[0-9]+');
        Route::get('product/bulkImport', 'ProductController@bulkImport')->name('products.bulkImport')->where('id', '[0-9]+');
