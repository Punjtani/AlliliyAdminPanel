                        ...
                        <tbody class="list">
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Customer')">
                                    <a>{{ @$item->customer->first_name. ' '.@$item->customer->last_name }}</a>
                                </td>
                                ...
                                @if(!request()->routeIs('admin.order.cod'))
                                    <td data-label="@lang('Payment Via')">
                                        ...
                                        @elseif(@$item->deposit) --}}
                                            <strong class="text-primary">{{ $item->payment_gateway_names[0]}}</strong>
                                        {{-- @endif --}}
                                    </td>
                                @endif

                                <td data-label="@lang('Amount')" class="text-right">
                                    <b>{{ $general->cur_sym.(@$item->total_price) }}</b>
                                </td>
                                @if(request()->routeIs('admin.order.index'))
                                ...
                                <td data-label="@lang('Action')">
                                    ...
                                    <a href="{{ route('seller.order.details', @$item->id) }}" data-toggle="tooltip" title="@lang('View')" class="icon-btn btn--dark mr-1">
