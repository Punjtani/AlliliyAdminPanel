                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Action')">
                                    ...
                                    <a href="@if($product->trashed()) javascript:void(0) @else {{ route('admin.products.import', [$product->id, slug($product->name)]) }} @endif" class="icon-btn btn--primary {{$product->trashed()?'disabled':''}} mr-1" data-toggle="tooltip" data-placement="top" title="@lang('Import')">
...
@push('breadcrumb-plugins')
    ...
    @endif
    <a href="{{ route('admin.products.bulkImport') }}" data-toggle="tooltip" title="@lang('Shortcut'): shift+n" class="btn btn-sm btn--success box--shadow1 text--small"><i class="la la-plus"></i>@lang('Product Bulk Import')</a>
